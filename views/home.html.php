<div class="d-none d-sm-block" id="calendars">
  ...
  <div class="cal-events">
    ...
    <?php foreach ($evenements as $nom => $evts): $evenement = current($evts); ?>
      <div class="cal-ligne">
      <div class="cal-titre" data-bs-toggle="tooltip" data-bs-html="true" data-bs-title="<strong><?php echo $nom ?></strong><?php if($type != "Sans date butoir"): ?><i class='bi bi-calendar'></i> <?php var_dump($evenement->isDate()); echo \Helpers\MonthTimeline::renderDatelines($evenement) ?><?php endif; ?><br /><i class='bi bi-buildings'></i> <?php echo implode("<br /><i class='bi bi-buildings'></i> ", $evenement->getNomsOrganismes(true)) ?><?php if($evenement->liendeclaration): ?><br /><i class='bi bi-globe'></i> <?php echo $evenement->liendeclaration ?><?php endif; ?>" data-bs-placement="right" data-bs-custom-class="tooltip-app">
