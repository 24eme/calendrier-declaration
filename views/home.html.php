<div class="d-none d-sm-block px-3" id="calendar" style="">
  ...
  <div class="cal-events">
    ...
    <?php foreach ($evenements as $nom => $evts): $evenement = current($evts); ?>
      ...
      <div class="cal-titre" title="<?php echo $nom ?>">
        <a class="cal-titre-txt" href="<?php echo Base::instance()->alias('event', ['evenement' => $evenement->id], Base::instance()->get('activefiltersparams')) ?>"><?php if ($evenement->nom_court) {echo $evenement->nom_court;} else { echo $nom;} ?></a>
